...
def compile_landmap(input_path, landmap_path, additive_path):
    landmap_command = 'magick ' + input_path + ' -flatten -resize 1024x1024 -channel B -separate' + ' GRAY:' + landmap_path 
    additive_command = 'magick ' + input_path + ' -flatten -resize 1024x1024 -channel R -separate' + ' GRAY:' + additive_path
