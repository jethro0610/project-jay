...
void SkeletonResource::CalculateBasePoseJointTransforms(mat4* outputJointTransforms) {
...
void SkeletonResource::CalculateBasePoseJointTransforms_Recursive(int currentJointIndex, mat4* outputJointTransforms) {
